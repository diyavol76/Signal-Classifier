...
class LoadDataset():
    ...
    def load_iq_samples(self, file_path, dev_range, pkt_range):
       ...
       #num_dev=2
        ...
        #TODO
        #sample_index_list = np.arange(0, 110, 1, dtype=int)
        sample_index_list=sorted(sample_index_list)
...
class ChannelIndSpectrogram():
    ...
    def _normalization(self,data):
        ...
        s_norm = np.zeros(np.shape(data), dtype=complex)
