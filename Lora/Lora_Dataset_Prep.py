...
if __name__ == '__main__':
    ...
    file_path_enrol=r'D:\iot\data\net\dataset\Train\dataset_training_aug.h5'
    dev_range_enrol=np.arange(0,9, dtype = int)
    pkt_range_enrol=np.arange(0,750, dtype = int)
    LoadDatasetObj = LoadDataset()
    data, label = LoadDatasetObj.load_iq_samples(file_path_enrol, dev_range_enrol, pkt_range_enrol)
